 ...
 * @author A3
 */
public class DisplayStatBlock extends JPanel {
    ...
    public DisplayStatBlock(PC pc) {
        super();
        this.statBlock = pc.getStatBlock();
        ...
        sTF = new JTextField("" + statBlock.getStat(Stat.STR));
        sTF.setColumns(4);
        c.gridx = 0;
        c.gridy = 0;
        add(strLabel, c);
        ...
        dTF = new JTextField("" + statBlock.getStat(Stat.DEX));
        dTF.setColumns(4);
        c.gridx = 0;
        c.gridy = 1;
        add(dexLabel, c);
        ...
        coTF = new JTextField("" + statBlock.getStat(Stat.CON));
        coTF.setColumns(4);
        c.gridx = 0;
        c.gridy = 2;
        add(conLabel, c);
        ...
        iTF = new JTextField("" + statBlock.getStat(Stat.INT));
        iTF.setColumns(4);
        c.gridx = 0;
        c.gridy = 3;
        ...
        wTF = new JTextField("" + statBlock.getStat(Stat.WIS));
        wTF.setColumns(4);
        c.gridx = 0;
        c.gridy = 4;
        add(wisLabel, c);
        ...
        chTF = new JTextField("" + statBlock.getStat(Stat.CHA));
        chTF.setColumns(4);
        c.gridx = 0;
        c.gridy = 5;
        add(chaLabel, c);
